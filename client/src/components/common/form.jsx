                     ...
                     <SelectContent>
                        {
                            ...
                            getControlItem.options.length>0 ? getControlItem.options.map(optoinItem=><SelectItem key={optoinItem.id}value={optoinItem.label}>{optoinItem.label}</SelectItem>) :null 
                        }
                     </SelectContent>
                    </Select>
                )
